...
public class MEBlockstateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockItem(MEBlocks.ASTROSTONE_BLOCK.get(), models().cubeAll(MEBlocks.ASTROSTONE_BLOCK.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_1.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_1.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_1.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_2.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_2.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_2.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_2.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_3.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_3.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_3.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_3.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_4.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_4.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_4.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_4.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_5.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_5.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_5.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_5.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_6.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_6.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_6.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_6.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_7.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_7.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_7.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_7.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_8.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_8.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_8.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_8.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_9.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_9.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_9.getId().getPath(),
                blockTexture(MEBlocksDataGen.FRAMED_GLASS_9.get())));
        simpleBlock(MEBlocksDataGen.FRAMED_GLASS_10.get());
        simpleBlockItem(MEBlocksDataGen.FRAMED_GLASS_10.get(), models().cubeAll(MEBlocksDataGen.FRAMED_GLASS_10.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.BEIGE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.BLACK_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.BLUE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.BROWN_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.FADED_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.GREEN_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.GREY_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.MAROON_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.NAVY_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.ORANGE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.PALE_BLUE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.PINK_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.PURPLE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.RED_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.SWAMPY_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.WHITE_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS_STAIRS.get(), models().stairs(MEBlocksDataGen.YELLOW_BRICKS_STAIRS.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.BEIGE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.BLACK_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.BLUE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.BROWN_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.FADED_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.GREEN_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.GREY_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.MAROON_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.NAVY_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.ORANGE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.PALE_BLUE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.PINK_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.PURPLE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.RED_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.SWAMPY_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.WHITE_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS_STAIRS_MOSSY.get(), models().stairs(MEBlocksDataGen.YELLOW_BRICKS_STAIRS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.BEIGE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.BEIGE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.BLACK_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS.get(), models().cubeAll(MEBlocksDataGen.BLACK_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLACK_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.BLUE_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.BLUE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLUE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.BROWN_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS.get(), models().cubeAll(MEBlocksDataGen.BROWN_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.BROWN_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.FADED_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS.get(), models().cubeAll(MEBlocksDataGen.FADED_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.FADED_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.GREEN_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS.get(), models().cubeAll(MEBlocksDataGen.GREEN_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREEN_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.GREY_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS.get(), models().cubeAll(MEBlocksDataGen.GREY_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREY_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.MAROON_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS.get(), models().cubeAll(MEBlocksDataGen.MAROON_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.MAROON_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.NAVY_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS.get(), models().cubeAll(MEBlocksDataGen.NAVY_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.NAVY_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.ORANGE_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.ORANGE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.ORANGE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.PALE_BLUE_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.PALE_BLUE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.PINK_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS.get(), models().cubeAll(MEBlocksDataGen.PINK_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.PINK_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.PURPLE_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.PURPLE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.PURPLE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.RED_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS.get(), models().cubeAll(MEBlocksDataGen.RED_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.RED_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.SWAMPY_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS.get(), models().cubeAll(MEBlocksDataGen.SWAMPY_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.SWAMPY_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.WHITE_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS.get(), models().cubeAll(MEBlocksDataGen.WHITE_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.WHITE_BRICKS.get())));
        simpleBlock(MEBlocksDataGen.YELLOW_BRICKS.get());
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS.get(), models().cubeAll(MEBlocksDataGen.YELLOW_BRICKS.getId().getPath(),
                blockTexture(MEBlocksDataGen.YELLOW_BRICKS.get())));

        simpleBlock(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.BLACK_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.BLUE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.BROWN_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.FADED_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.FADED_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.FADED_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.GREEN_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.GREY_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.GREY_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREY_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.MAROON_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.NAVY_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.PINK_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.PINK_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PINK_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.RED_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.RED_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.RED_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.WHITE_BRICKS_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get())));
        simpleBlock(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.get());
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.get(), models().cubeAll(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.getId().getPath(),
        ...
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.BEIGE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.BEIGE_BRICKS.get()), blockTexture(MEBlocksDataGen.BEIGE_BRICKS.get()), blockTexture(MEBlocksDataGen.BEIGE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.BLACK_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLACK_BRICKS.get()), blockTexture(MEBlocksDataGen.BLACK_BRICKS.get()), blockTexture(MEBlocksDataGen.BLACK_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.BLUE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLUE_BRICKS.get()), blockTexture(MEBlocksDataGen.BLUE_BRICKS.get()), blockTexture(MEBlocksDataGen.BLUE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.BROWN_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.BROWN_BRICKS.get()), blockTexture(MEBlocksDataGen.BROWN_BRICKS.get()), blockTexture(MEBlocksDataGen.BROWN_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.FADED_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.FADED_BRICKS.get()), blockTexture(MEBlocksDataGen.FADED_BRICKS.get()), blockTexture(MEBlocksDataGen.FADED_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.GREEN_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREEN_BRICKS.get()), blockTexture(MEBlocksDataGen.GREEN_BRICKS.get()), blockTexture(MEBlocksDataGen.GREEN_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.GREY_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREY_BRICKS.get()), blockTexture(MEBlocksDataGen.GREY_BRICKS.get()), blockTexture(MEBlocksDataGen.GREY_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.MAROON_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.MAROON_BRICKS.get()), blockTexture(MEBlocksDataGen.MAROON_BRICKS.get()), blockTexture(MEBlocksDataGen.MAROON_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.NAVY_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.NAVY_BRICKS.get()), blockTexture(MEBlocksDataGen.NAVY_BRICKS.get()), blockTexture(MEBlocksDataGen.NAVY_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.ORANGE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.ORANGE_BRICKS.get()), blockTexture(MEBlocksDataGen.ORANGE_BRICKS.get()), blockTexture(MEBlocksDataGen.ORANGE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.PALE_BLUE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS.get()), blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS.get()), blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.PINK_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.PINK_BRICKS.get()), blockTexture(MEBlocksDataGen.PINK_BRICKS.get()), blockTexture(MEBlocksDataGen.PINK_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.PURPLE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.PURPLE_BRICKS.get()), blockTexture(MEBlocksDataGen.PURPLE_BRICKS.get()), blockTexture(MEBlocksDataGen.PURPLE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.RED_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.RED_BRICKS.get()), blockTexture(MEBlocksDataGen.RED_BRICKS.get()), blockTexture(MEBlocksDataGen.RED_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.SWAMPY_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.SWAMPY_BRICKS.get()), blockTexture(MEBlocksDataGen.SWAMPY_BRICKS.get()), blockTexture(MEBlocksDataGen.SWAMPY_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.WHITE_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.WHITE_BRICKS.get()), blockTexture(MEBlocksDataGen.WHITE_BRICKS.get()), blockTexture(MEBlocksDataGen.WHITE_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS_SLAB.get(), models().slab(MEBlocksDataGen.YELLOW_BRICKS_SLAB.getId().getPath(),
                blockTexture(MEBlocksDataGen.YELLOW_BRICKS.get()), blockTexture(MEBlocksDataGen.YELLOW_BRICKS.get()), blockTexture(MEBlocksDataGen.YELLOW_BRICKS.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BEIGE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.BEIGE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BEIGE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BLACK_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.BLACK_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BLACK_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BLUE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.BLUE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BLUE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.BROWN_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.BROWN_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.BROWN_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.FADED_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.FADED_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.FADED_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.FADED_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.FADED_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.GREEN_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.GREEN_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.GREEN_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.GREY_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.GREY_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.GREY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.GREY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.GREY_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.MAROON_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.MAROON_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.MAROON_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.NAVY_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.NAVY_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.NAVY_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.ORANGE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.ORANGE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.ORANGE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PALE_BLUE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.PALE_BLUE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PALE_BLUE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PINK_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.PINK_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PINK_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PINK_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PINK_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.PURPLE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.PURPLE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.PURPLE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.RED_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.RED_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.RED_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.RED_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.RED_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.SWAMPY_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.SWAMPY_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.SWAMPY_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.WHITE_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.WHITE_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.WHITE_BRICKS_MOSSY.get())));
        ...
        simpleBlockItem(MEBlocksDataGen.YELLOW_BRICKS_SLAB_MOSSY.get(), models().slab(MEBlocksDataGen.YELLOW_BRICKS_SLAB_MOSSY.getId().getPath(),
                blockTexture(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.get()), blockTexture(MEBlocksDataGen.YELLOW_BRICKS_MOSSY.get())));
