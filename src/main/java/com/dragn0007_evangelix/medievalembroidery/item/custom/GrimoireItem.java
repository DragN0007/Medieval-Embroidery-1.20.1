...
public class GrimoireItem extends Item implements IAnimatable, ISyncable {
	private static final String CONTROLLER_NAME = "openController";
	private static final String CONTROLLER_IDLE_NAME = "openidleController";
	...
	public void initializeClient(Consumer<IItemRenderProperties> consumer) {
		...
		consumer.accept(new IItemRenderProperties() {
			private final BlockEntityWithoutLevelRenderer renderer = new GrimoireRender();
	...
	public void onAnimationSync(int id, int state) {
		if (state == ANIM_OPEN) {
			...
			if (controller.getAnimationState() == AnimationState.Stopped) {
				...
				controller.setAnimation(new AnimationBuilder().addAnimation("open", EDefaultLoopTypes.PLAY_ONCE));
			}
		}
	}
}
