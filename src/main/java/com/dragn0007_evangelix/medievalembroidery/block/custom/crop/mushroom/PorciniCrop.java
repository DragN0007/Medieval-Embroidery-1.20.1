...
public class PorciniCrop extends MEMushroomCropBlock {
    public PorciniCrop(Properties properties) {
        super(properties);
    }

    @Override
    public BlockState getPlant(BlockGetter level, BlockPos pos) {
        return MEBlocks.PORCINI.get().defaultBlockState();
    }

    @Override
    public ItemLike getBaseSeedId() {
        return MEItems.PORCINI.get();
    }
}
