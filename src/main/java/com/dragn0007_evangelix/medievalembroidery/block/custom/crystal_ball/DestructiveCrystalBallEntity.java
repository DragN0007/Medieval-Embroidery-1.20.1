...
public class DestructiveCrystalBallEntity extends BlockEntity implements GeoBlockEntity {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public int tickCount;
	private final List<BlockPos> effectBlocks = Lists.newArrayList();

	public DestructiveCrystalBallEntity(BlockPos pos, BlockState state) {
		super(MEBlocks.DESTRUCTIVE_CRYSTAL_BALL_ENTITY.get(), pos, state);
	}

	public static void serverTick(Level level, BlockPos pos, BlockState state, DestructiveCrystalBallEntity entity) {
		++entity.tickCount;
