...
public class ProtectiveCrystalBallEntity extends BlockEntity implements GeoBlockEntity {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public int tickCount;
	private final List<BlockPos> effectBlocks = Lists.newArrayList();

	public ProtectiveCrystalBallEntity(BlockPos pos, BlockState state) {
		super(MEBlocks.PROTECTIVE_CRYSTAL_BALL_ENTITY.get(), pos, state);
	}

	public static void serverTick(Level level, BlockPos pos, BlockState state, ProtectiveCrystalBallEntity entity) {
		++entity.tickCount;
