...
public class WoodsChickenCrop extends MEMushroomCropBlock {
    public WoodsChickenCrop(Properties properties) {
        super(properties);
    }

    @Override
    public BlockState getPlant(BlockGetter level, BlockPos pos) {
        return MEBlocks.WOODS_CHICKEN.get().defaultBlockState();
    }

    @Override
    public ItemLike getBaseSeedId() {
        return MEItems.WOODS_CHICKEN.get();
    }
}
