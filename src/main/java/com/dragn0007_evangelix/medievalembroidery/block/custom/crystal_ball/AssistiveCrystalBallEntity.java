...
public class AssistiveCrystalBallEntity extends BlockEntity implements GeoBlockEntity {
	...
	public AssistiveCrystalBallEntity(BlockPos pos, BlockState state) {
		super(MEBlocks.ASSISTIVE_CRYSTAL_BALL_ENTITY.get(), pos, state);
	}

	public static void serverTick(Level level, BlockPos pos, BlockState state, AssistiveCrystalBallEntity entity) {
		++entity.tickCount;
