...
public final class DepthstoneArmorRenderer extends GeoArmorRenderer<DepthstoneArmorItem> {

	public DepthstoneArmorRenderer() {

		super(new GeoModel<>() {
			@Override
			public ResourceLocation getModelResource(DepthstoneArmorItem animatable) {
				return new ResourceLocation(MedievalEmbroidery.MODID, "geo/gem_armor.geo.json");
			}

			@Override
			public ResourceLocation getTextureResource(DepthstoneArmorItem animatable) {
				return new ResourceLocation(MedievalEmbroidery.MODID, "textures/armor/depthstone_armor_heart.png");
			}

			@Override
			public ResourceLocation getAnimationResource(DepthstoneArmorItem animatable) {
