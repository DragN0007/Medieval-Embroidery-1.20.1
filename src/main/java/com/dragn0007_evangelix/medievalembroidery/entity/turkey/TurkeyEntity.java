...
public class TurkeyEntity extends Animal implements IAnimatable {
    ...
    public TurkeyEntity(EntityType<? extends Animal> entityType, Level level) {
   ...
   protected SoundEvent getDeathSound() {
    ...
    public ResourceLocation getTextureLocation() {
        return TurkeyModel.Variant.variantFromOrdinal(getVariant()).resourceLocation;
    }


    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(TurkeyEntity.class, EntityDataSerializers.INT);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag compoundTag) {
        ...
        setVariant(new Random().nextInt(TurkeyModel.Variant.values().length));
    ...
    @Nullable
    @Override
    public TurkeyEntity getBreedOffspring(ServerLevel p_148890_, AgeableMob p_148891_) {
        return EntityTypes.TURKEY_ENTITY.get().create(p_148890_);
    }
