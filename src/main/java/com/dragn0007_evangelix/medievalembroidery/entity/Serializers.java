...
public class Serializers {
    ...
    public static final DeferredRegister<DataSerializerEntry> RESOURCE_SERIALIZER_REGISTER = DeferredRegister.create(ForgeRegistries.Keys.DATA_SERIALIZERS, MedievalEmbroideryMain.MODID);
